#!/bin/sh
#PBS -N Run_CPU_2DES_5pulse       
#PBS -r n
#PBS -e Run_CPU_2DES_5pulse.pbserr
#PBS -o Run_CPU_2DES_5pulse.pbslog
#PBS -q long
...
TLIST="50 150 250 350 450"

# Loop through all combinations of TAU and T
for TAU in $(seq -600 10 600); do
    for T in $TLIST; do
        INPUT_FILE="/home/andrew91411/CPU_2DES/2d_input/key_${TAU}_${T}_wc100.key"
        OUTPUT_FILE="/home/andrew91411/CPU_2DES/2d_output/out_${TAU}_${T}_wc100.out"
